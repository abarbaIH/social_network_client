...
const Followers = () => {
    ...
    const getUsers = async (nextPage = 1) => { // la pagina por defecto debe ser 1
        ...
        const request = await fetch(`${Global.url}follow/followersList/${userId}/${nextPage}`, {
            method: "GET",
            headers: {
        ...
        // Recorrer y limpiar data.usersFollowersList para quedarme con la propiedad followed
        let cleanUsers = []
        data.usersFollowersList.forEach(follow => {
